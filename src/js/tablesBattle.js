export const battleTables = [
    ...
    },
    {
        ...
        tables: {
            ...
            interestedparties: [                
                { "label": "Renegade Soldiers", "description": "{ \"numbers\": 1, \"weapons\": \"2B\" }", "weight": 7 },
                { "label": "Bounty Hunters", "description": "{ \"numbers\": 0, \"weapons\": \"1B\" }", "weight": 7 },
                { "label": "Abandoned", "description": "{ \"numbers\": 1, \"weapons\": \"1A\" }", "weight": 5 },
                { "label": "Vigilantes", "description": "{ \"numbers\": 1, \"weapons\": \"2A\" }", "weight": 9 },
                { "label": "Isolationists", "description": "{ \"numbers\": 1, \"weapons\": \"1A\" }", "weight": 8 },
                { "label": "Zealots", "description": "{ \"numbers\": 2, \"weapons\": \"1A\" }", "weight": 6 },
                { "label": "Mutants", "description": "{ \"numbers\": 3, \"weapons\": \"1A\" }", "weight": 7 },
                { "label": "Primitives", "description": "{ \"numbers\": 2, \"weapons\": \"Blade,Brutal Melee Weapon\" }", "weight": 4 },
                { "label": "Precursor Exiles", "description": "{ \"numbers\": 0, \"weapons\": \"3B\" }", "weight": 4 },
                { "label": "K'Erin Colonists", "description": "{ \"numbers\": 1, \"weapons\": \"2A\" }", "weight": 7 },
                { "label": "Swift War Squad", "description": "{ \"numbers\": 2, \"weapons\": \"1B\" }", "weight": 5 },
                { "label": "Soulless Task Force", "description": "{ \"numbers\": 0, \"weapons\": \"3C\" }", "weight": 4 },
                { "label": "Tech Zealots", "description": "{ \"numbers\": 1, \"weapons\": \"3C\" }", "weight": 4 },
                { "label": "Colonial Militia", "description": "{ \"numbers\": 1 , \"weapons\": \"2B\" }", "weight": 7 },
                { "label": "Planetary Nomads", "description": "{ \"numbers\": 2, \"weapons\": \"2A\" }", "weight": 5 },
                { "label": "Salvage Team", "description": "{ \"numbers\": 1, \"weapons\": \"2B\" }", "weight": 12 },
            ],
            rovingthreats: [                
                { "label": "Converted Acquisition", "description": "{ \"numbers\": 1, \"weapons\": \"2B\" }", "weight": 5 },
                { "label": "Converted Infiltrators", "description": "{ \"numbers\": 0, \"weapons\": \"1A\" }", "weight": 8 },
                { "label": "Abductor Raiders", "description": "{ \"numbers\": 3, \"weapons\": \"2A\" }", "weight": 6 },
                { "label": "Swarm Brood", "description": "{ \"numbers\": 2, \"weapons\": \"Claws(Damage +1)\" }", "weight": 10 },
                { "label": "Haywire Robots", "description": "{ \"numbers\": 2, \"weapons\": \"Smash (Damage +0)\" }", "weight": 6 },
                ...
                { "label": "Distorts", "description": "{ \"numbers\": 0, \"weapons\": \"Touch (Damage +3)\" }", "weight": 3 },
            ],
        }
    },
    {
